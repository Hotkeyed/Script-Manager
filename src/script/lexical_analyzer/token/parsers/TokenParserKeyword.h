...
struct TokenParserKeyword : public TokenParser {
    ...
    constexpr std::string type() const override { return "Keyword"; };
    virtual const std::unordered_set<std::string> keywords() const override { return {
        "if", "else", "while", "for", "return", "int", "bool", "float", "string", "true", "false"
    }; }
    constexpr int precedence() const override { return 9; };
};